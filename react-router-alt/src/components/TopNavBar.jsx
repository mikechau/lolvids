      ...
      <nav className="navbar navbar-default navbar-static-top">
        <div className="container-fluid">
          <div className="navbar-header">
            ...
            <a className="navbar-brand" href="/react-router-alt">lolvids-react-alt</a>
          </div>

          <div ref="collapsedNavMenuOptions" className={collapsedNavMenuClasses}>
            <ul className="nav navbar-nav">
              <li className="active"><a href="/react-router-alt">Home <span className="sr-only">(current)</span></a></li>
            ...
            <ul className="nav navbar-nav navbar-right">
              <Dropdown title="Other Examples">
                ...
                <li className="active"><a href="/react-router-alt">react-router-alt</a></li>
              </Dropdown>
            </ul>
          </div>
        </div>
