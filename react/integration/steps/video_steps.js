  ...
  this
    ...
    .when(/I wait for the video to end/, function(done) {
      this
        .browser
        .execute(function() {
          var playerEl = document.getElementsByTagName('video')[0];
    ...
    .then(/I see the "$string" is( not)? (\d+|empty|"(.*?)")/, function(selectorId, not, expectedValue, expectedString, done) {
